...
bool lio_sam__srv__save_map__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("lio_sam.srv._save_map.SaveMap_Request", full_classname_dest, 37) == 0);
  }
  lio_sam__srv__SaveMap_Request * ros_message = _ros_message;
  {  // resolution
...
PyObject * lio_sam__srv__save_map__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("lio_sam.srv._save_map");
...
ROSIDL_GENERATOR_C_EXPORT
bool lio_sam__srv__save_map__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("lio_sam.srv._save_map.SaveMap_Response", full_classname_dest, 38) == 0);
  }
  lio_sam__srv__SaveMap_Response * ros_message = _ros_message;
  {  // success
